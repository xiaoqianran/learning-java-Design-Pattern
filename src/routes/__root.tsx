...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        title: "Java 设计模式实战 · 系统路径",
      },
      {
        name: "description",
        content:
          "Java 设计模式中文交互教程：GoF 23 + SOLID + Spring 落地、讲解+源码+交互沙盘、进度与结业。",
      },
    ],
    links: [
...
const CTP_BOOT =
  "(function(){try{var f=localStorage.getItem('java-dp-learn-ctp-flavor');var a=localStorage.getItem('java-dp-learn-ctp-accent');var okF=['mocha','macchiato','frappe','latte'];var okA=['green','mauve','blue','lavender','sapphire','teal','peach','pink'];if(okF.indexOf(f)<0)f='mocha';if(okA.indexOf(a)<0)a='sapphire';document.documentElement.setAttribute('data-ctp-flavor',f);document.documentElement.setAttribute('data-ctp-accent',a);}catch(e){document.documentElement.setAttribute('data-ctp-flavor','mocha');document.documentElement.setAttribute('data-ctp-accent','sapphire');}})();";
